...
# 1. Select only the necessary columns from your summary to keep the join clean
...
set.seed(36)
trainIndex <- createDataPartition(X_model$Price_in_Lakhs, p = 0.8, list = FALSE)
...
```{r}
lm2 <- lm(Price_in_Lakhs ~ Size_in_SqFt+Price_per_SqFt , data = train_data)
